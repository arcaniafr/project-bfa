				...
				<ul class="arc-forum mr-10">
					...
					<li class="body">
						<ul class="sticky">
							...
							<li class="cell-info">
								<a href="bugtracker-details.php" class="title h4">Sticky Topic</a>
						...
						<li class="cell-info">
						<a href="bugtracker-details.php" class="title h4">Normal Topic</a>
						<div class="description"> Started by: <a href="#">
						<img alt="" src="assets/images/no-avatar.png" height="15" width="15"> John Doe </a>
						</div>
						</li>
						...
						<li class="cell-info">
						<a href="bugtracker-details.php" class="title h4">Closed Topic</a>
						 <div class="description"> Started by: <a href="#">
						<img alt="" src="assets/images/no-avatar.png" height="15" width="15"> John Doe </a>
						</div>
						</li>
